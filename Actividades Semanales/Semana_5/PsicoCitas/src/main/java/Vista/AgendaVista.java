...
public class AgendaVista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tablaCitas.setBackground(new java.awt.Color(192, 248, 146));
        tablaCitas.setFont(new java.awt.Font("Segoe UI", 2, 12)); // NOI18N
        tablaCitas.setForeground(new java.awt.Color(51, 51, 51));
        ...
        lblFiltro.setFont(new java.awt.Font("Book Antiqua", 2, 14)); // NOI18N
        lblFiltro.setForeground(new java.awt.Color(95, 150, 50));
        lblFiltro.setText("Filtrar por psicologo :");

        comboPsicologos.setFont(new java.awt.Font("Segoe UI", 2, 12)); // NOI18N
        comboPsicologos.setForeground(new java.awt.Color(51, 51, 51));
